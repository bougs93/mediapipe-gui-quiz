...
# ####### 버튼 관련 #######################################################
BUTTON_TEXT_POS_X = 10 ; BUTTON_TEXT_POS_Y = 60 # 버튼 내부 텍스트 상대위치 10, 50

BUTTON_SIZE_X = 60 ; BUTTON_SIZE_Y = 80         # 버튼 사이즈 60, 60
BUTTON_CAP_X = 27  ; BUTTON_CAP_Y = 20          # 버튼 사이간격
BUTTON_START_X = 240 ; BUTTON_START_Y = 290      # 버튼 시작 위치 margin (처음 위치만 지정)
BUTTON_FONT_SIZE = 2
# ####### 버튼 관련 #######################################################
...
# cv2.circle(img, (200, 100), RADIUS, COLOR, THICKNESS, cv2.LINE_AA)  # 속 빈 원
    ...
    def button_choice1_create(self):
        ...
        BUTTON_SIZE_X = 60 ; BUTTON_SIZE_Y = 80         # 버튼 사이즈 60, 60
        BUTTON_CAP_X = 33  ; BUTTON_CAP_Y = 20          # 버튼 사이간격
    ...
    def button_yn_create(self):
        ...
        BUTTON_SIZE_X = 60 ; BUTTON_SIZE_Y = 80         # 버튼 사이즈 60, 60
        BUTTON_CAP_X = 33  ; BUTTON_CAP_Y = 20          # 버튼 사이간격
        BUTTON_START_X = 200 + 220 ;       # 버튼 시작 위치 margin (처음 위치만 지정)
    ...
    def button_start_create(self):
        ...
        BUTTON_SIZE_X = 60 ; BUTTON_SIZE_Y = 80         # 버튼 사이즈 60, 60
        BUTTON_CAP_X = 33  ; BUTTON_CAP_Y = 20          # 버튼 사이간격
        BUTTON_START_X = 240 + 220 ;       # 버튼 시작 위치 margin (처음 위치만 지정)
    ...
    def button_user_create(self):
                     # 60/10
        BUTTON_SIZE_X = 58 ; BUTTON_SIZE_Y = 80   # 버튼 사이즈 60, 60-사이즈 변경불가,*기본값에서 변경않됨.
        BUTTON_CAP_X = 12  ; BUTTON_CAP_Y = 20     # 버튼 사이간격
        BUTTON_START_X = 5 + 220 ;       # 버튼 시작 위치 margin (처음 위치만 지정)
