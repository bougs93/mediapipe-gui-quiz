...
"border-radius: 30px;")
        ...
        self.lb_id.setGeometry(QRect(520, 560, 241, 81))
        font4 = QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.lb_name.setGeometry(QRect(770, 560, 331, 81))
...
"color: rgb(255, 255, 255);")
        ...
        self.lb_grade.setGeometry(QRect(860, 470, 241, 81))
...
"color: rgb(255, 255, 255);")
        ...
        self.lb_school.setGeometry(QRect(520, 470, 331, 81))
...
"color: rgb(255, 255, 255);")
        ...
        self.lb_quiz_name.setGeometry(QRect(50, 560, 461, 81))
...
"border-radius: 30px;")
        ...
        font6 = QFont()
        font6.setFamilies([u"\ub098\ub214\uc2a4\ud018\uc5b4\ub77c\uc6b4\ub4dc ExtraBold"])
        ...
        self.lb_keytime.setGeometry(QRect(1120, 16, 141, 31))
        font7 = QFont()
        font7.setFamilies([u"\ub098\ub214\uc2a4\ud018\uc5b4\ub77c\uc6b4\ub4dc ExtraBold"])
        font7.setPointSize(15)
        font7.setBold(True)
        self.lb_keytime.setFont(font7)
...
"background-color: rgba(255, 255, 255, 150);")
        ...
        self.lb_mode_img = QLabel(user_reg)
    ...
    def retranslateUi(self, user_reg):
        ...
        self.lb_mode_img.setText(QCoreApplication.translate("user_reg", u"mode_img", None))
    # retranslateUi
